...
var grammar = {
    Lexer: undefined,
    ParserRules: [
    {"name": "function", "symbols": ["_funDeclaration", "_decl", "_varList"], "postprocess": function(d) {return {'funName':d[0],'vars':d[2]} }},
    ...
    {"name": "_var$string$3", "symbols": [{"literal":"("}, {"literal":")"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "_var", "symbols": ["_", "_var$string$1", "_", "_name", "_", "_var$string$2", "_", "_name", "_", "_var$string$3", "e"], "postprocess": function(d){return {'varName' : d[3], 'type' : d[7] } }},
